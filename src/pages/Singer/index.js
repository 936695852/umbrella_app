...
import { HEADER_HEIGHT } from '../../baseUl/header/index'
import Header from '../../baseUl/header/index'
import Scroll from '../../baseUl/scroll'
import SongList from '../../components/SongList'
import Loading from '../../baseUl/loading'

import { connect } from 'react-redux'
import { getSingerInfo, changeEnterLoading } from '../../store/singer/actionCreators'
...
function Singer(props) {
  ...
  return (
    ...
    >
      <Container>
        <Header handleClick={handleBack} title={artist.name} ref={header}></Header>
        <ImgWrapper ref={imageWrapper} bgUrl={artist.picUrl}>
          <div className="filter"></div>
        </ImgWrapper>
        <CollectButton ref={collectButton}>
          <FiPlus className="iconfont" />
